"""Deals router - product listings with pagination and filtering."""
...
async def get_deals(
    ...
    """Get paginated list of deals with optional category filter."""
    ...
    return DealListResponse(products=deals, total=total, hasMore=has_more)
