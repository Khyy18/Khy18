...
1. **Шифрование данных (AES-256-GCM)** - персональные данные сотрудников и детей шифруются перед сохранением в базу. Ключ шифрования задается через переменную окружения `ENCRYPTION_KEY`.
